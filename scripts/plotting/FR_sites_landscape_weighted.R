...
## Outputfiles:
outputfile_heatmapplot_FR <- "foldresistance_DMS_sites_epitopes_weighted.pdf"
...
heatmap.2(as.matrix(FRlg2), main = paste0("Fold Resistance per site (log 10 scale) DMS"), col=colorcoding, #symm = T,
