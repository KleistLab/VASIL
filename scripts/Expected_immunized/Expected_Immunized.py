...
file1 = open(sys.argv[3], "rb") # premade simulations
...
file1 = open(sys.argv[4], "rb") # Check that this is the file you want to load
...
frequency_spk_df = pd.read_csv(sys.argv[6])
try:
...
def ei_util(i):
    ...
    EI_df.to_csv(sys.argv[7]+"Immunized_SpikeGroup_%s_all_PK.csv"%variant_to_sim[0])
