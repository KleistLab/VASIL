...
|-- Figure 4: a: MS_data/plots/P_neut_groups/P_Neut_.pdf/svg*         
                   ...
                   c: MS_data/plots/relative_groups/relative_fitness_*.pdf (available also separated)                             
```
...
![alt text](https://github.com/KleistLab/VASIL/blob/main/MS_data/plots/Cross_spikegroups/major_Cross_React_AB_A.svg)
